...
function Header() {
    ...
    useEffect(() => {
        if (isDarkTheme) {
            ...
            document.querySelector("#aboutMe").classList.add('dark-theme');
            document.querySelector("#aboutMe").classList.remove('light-theme');
            ...
            document.querySelector("#aboutMe").classList.add('light-theme');
            document.querySelector("#aboutMe").classList.remove('dark-theme');
            const cards = document.querySelectorAll('.card');
            cards.forEach(card => {
                const firstDiv = card.querySelector('div');
                if (firstDiv) {
                            ...
                            <ul className="navbar-nav">
                                ...
                                <li className="nav-item dropdown">
                                    ...
                                    <ul className="dropdown-menu">
                                        ...
                                        <button onClick={() => changeLanguage('ca')} className="btn btn-link">{t('catalan')}</button>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul className="navbar-nav">
                                <li className="nav-item" onClick={changeTheme}>
                                    {isDarkTheme ? (
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" className="icon" fill="currentColor" viewBox="0 0 16 16">
